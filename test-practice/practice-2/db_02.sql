...
CREATE TABLE `member_likes` (
  ...
  `user_id` int(11) UNSIGNED NOT NULL COMMENT '點讚會員的 ID',
  `post_id` int(11) UNSIGNED NOT NULL COMMENT '被點讚的最新消息 ID',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '點讚時間'
...
INSERT INTO `member_likes` (`id`, `user_id`, `post_id`, `created_at`) VALUES
(1, 0, 1, '2026-06-29 08:30:52'),
(2, 0, 2, '2026-06-29 08:30:55'),
(3, 0, 3, '2026-06-29 08:30:56'),
(4, 0, 4, '2026-06-29 08:31:01'),
(5, 0, 5, '2026-06-29 08:31:02'),
(6, 0, 6, '2026-06-29 08:31:03'),
(7, 0, 7, '2026-06-29 08:31:05'),
(8, 0, 8, '2026-06-29 08:31:06');
...
CREATE TABLE `posts` (
  ...
  `type` varchar(50) NOT NULL COMMENT '文章分類',
  `likes` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '按讚次數',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '狀態：0隱藏，1顯示',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '發文時間',
...
CREATE TABLE `surveys` (
  `id` int(11) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL COMMENT '題目或選項內容',
  `parent_id` int(11) UNSIGNED NOT NULL COMMENT '所屬題目 ID (0為題目)',
  `vote` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '總得票數'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `surveys` (`id`, `title`, `parent_id`, `vote`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?', 0, 10),
(2, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 4),
(3, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 2),
(4, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 3),
(5, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1, 1),
(6, '二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 0),
...
CREATE TABLE `users` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '帳號狀態 (0: 禁用, 1: 啟用)',
...
(1, 'admin', '1234', 'admin@labor.gov.tw', 'user', 0, '2026-08-11 03:18:48'),
(2, 'test', '5678', 'test@labor.gov.tw', 'user', 0, '2026-08-11 03:18:48'),
(3, 'mem01', 'mem01', 'mem01@labor.gov.tw', 'user', 0, '2026-08-11 03:18:48'),
(4, 'mem02', 'mem02', 'mem02@labor.gov.tw', 'user', 0, '2026-08-11 03:18:48');
...
CREATE TABLE `visit_logs` (
  `id` int(11) UNSIGNED NOT NULL,
  `visit_date` date NOT NULL COMMENT '訪問日期',
  `view_count` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '當日瀏覽人次'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `visit_logs` (`id`, `visit_date`, `view_count`) VALUES
(1, '2026-06-23', 2),
(2, '2026-06-29', 1),
(3, '2026-06-30', 1),
(4, '2026-08-09', 1);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `visit_logs`
--
ALTER TABLE `visit_logs`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
