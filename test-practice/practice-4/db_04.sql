...
INSERT INTO `product` (`id`, `product_number`, `name`, `price`, `specification`, `stock`, `image_path`, `introduction`, `parent_category_id`, `sub_category_id`, `status`) VALUES
