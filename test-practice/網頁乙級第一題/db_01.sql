...
(1, '轉知臺北教育大學與臺灣師大合辦第11屆麋研齋全國硬筆書法比賽活動', 1, 0),
(2, '轉知:法務部辦理「第五屆法規知識王網路闖關競賽辦法', 1, 0),
(3, '轉知2012年全國青年水墨創作大賽活動', 1, 0),
(4, '欣榮圖書館101年悅讀達人徵文比賽，歡迎全校師生踴躍投稿參加', 1, 0),
(5, '轉知:教育是人類升沉的樞紐-2013教師生命成長營', 1, 0);
...
INSERT INTO `mvim` (`id`, `src`, `text`, `sh`, `delete_at`) VALUES
(1, '01C01.gif', '', 1, 0),
(2, '01C02.gif', '', 1, 0),
(3, '01C03.gif', '', 1, 0),
(4, '01C04.gif', '', 1, 0);
...
INSERT INTO `news` (`id`, `text`, `sh`, `delete_at`) VALUES
...
INSERT INTO `title` (`id`, `src`, `text`, `sh`, `delete_at`) VALUES
(1, '01B01.jpg', '卓越科技大學校園資訊系統', 1, 0),
(2, '01B02.jpg', '卓越科技大學校園資訊系統', 0, 0),
(3, '01B03.jpg', '卓越科技大學校園資訊系統', 0, 0),
(4, '01B04.jpg', '卓越科技大學校園資訊系統', 0, 0);
